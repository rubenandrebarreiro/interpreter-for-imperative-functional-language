...
public class ASTGreaterThan implements ASTNode {
	...
	/**
	 * The TypeCheck Error Message for the A.S.T. Node for Greater Than
	 */
	private static final String TYPE_ERROR_MESSAGE = "Illegal arguments to > (greater than) operator!!!";
	...
	public void compile(EnvironmentCompiler environmentCompiler,
		...
		String instructionIfGreaterThan = String.format("ifgt L%d", label1);
